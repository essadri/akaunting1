<x-layouts.auth>
    ...
    <x-slot name="content">
        ...
        <x-form id="auth" route="register.public.store">
            <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5 lg:h-auto">
                <x-form.group.text
                    name="name"
                ...
                <x-form.group.text
                    ...
                    placeholder="{{ trans('install.settings.company_name') }}"
                    form-group-class="sm:col-span-6"
                    input-group-class="input-group-alternative"
                />
